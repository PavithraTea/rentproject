...
<html lang="en">
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
      <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="#page-top">RHMS</a>
    ...
    <header class="masthead">
      <div class="container">
        <div class="intro-text">
          <div class="intro-lead-in">Welcome To House Rental Management System</div>
                        ...
                        <div class="card-block">';
                         ...
                         echo   '<div class="row">
                          ...
                          echo '</div>
                            ...
                            echo '<div ><h3><b>For More Details <a href="makepayment.php">Click Here</a></b></h3></div>'   ;                           }else{
                                echo '<div class="alert alert-success" role="alert"><h3><b>Vacant!</b></h3></div>';
                                    echo '<div ><h3><b>For More Details <a href="makepayment.php">Click Here</a></b></h3></div>'   ;
                              } 
                            echo '</div>
                          </div>              
                         </div>
    ...
    <footer style="background-color: #ccc;">
      <div class="container">
        <div class="row">
          <div class="col-md-4">
            <span class="copyright">&copy; Rental House Management System - <?php echo date("Y"); ?></span>
          </div>
          <div class="col-md-4">
